...
Every command writes a [SARIF 2.1.0](https://sarifweb.azurewebsites.net/) report, the only output format, and prints one verdict line per package and the report path to the console.
