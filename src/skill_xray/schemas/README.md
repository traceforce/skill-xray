...
operating schema, vendored unchanged and included in wheels and source distributions.
Source builds reject missing or altered bytes; restore them from a trusted checkout.
...
Usage terms are provided by the OASIS SARIF specification:
